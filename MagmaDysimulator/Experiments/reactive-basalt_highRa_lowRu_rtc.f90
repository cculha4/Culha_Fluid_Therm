...
!-----------------------------------------------------------------------------
     ...
     program FVNS
        ...
        !--------------------------------------------------------
        xmx =   0.03*3                 ! maximum x coordinate value
        xmn =   0.                  ! min x
        ymx =   0.03                 ! max y
        ymn =   0.                  ! min y
        ...
        open(30,file="param_magma_chamber_ev_lowRa_"// nss //"_"// nsc //".dat")
...
!          call concentration_tracking(navxlct,navylct,xlct,ylct,u,v,u_lct,v_lct,dt)
           ...
           if (lm.eq.iout_max.or.t.ge.tmax.or.t.ge.xout(iout)) then
              ...
              open(10,file="data_magma_chamber_trc_ev_lowRa_" // nss // "_" // nsc //"_" // num // ".dat")
...
!               end do
!              close(10)
              open(10,file="data_magma_chamber_xtl_trc_ev_lowRa_" // nss // "_" // nsc //"_" // num // ".dat")
               write(10,*) 'TITLE = "velocity field"'
              ...
              close(10)
                  ...
                  open(10,file="data_magma_chamber_gctrc_ev_lowRa_" // nss // "_" // nsc //"_" // num // ".dat")
...
!        if (nsp.eq.5) then
         at = 225.!reference is 750 !160. !200 at 10 crystal diameter distance, 160 at 30 dx distance
