...
!-----------------------------------------------------------------------------
     ...
     program FVNS
        ...
        open(30,file="param_magma_chamber_ev_hghRu_"// nss //"_"// nsc //".dat")
...
!          call concentration_tracking(navxlct,navylct,xlct,ylct,u,v,u_lct,v_lct,dt)
           ...
           if (lm.eq.iout_max.or.t.ge.tmax.or.t.ge.xout(iout)) then
              ...
              open(10,file="data_magma_chamber_trc_ev_hghRu_" // nss // "_" // nsc //"_" // num // ".dat")
...
!               end do
!              close(10)
              open(10,file="data_magma_chamber_xtl_trc_ev_hghRu_" // nss // "_" // nsc //"_" // num // ".dat")
               write(10,*) 'TITLE = "velocity field"'
              ...
              close(10)
                  ...
                  open(10,file="data_magma_chamber_gctrc_ev_hghRu_" // nss // "_" // nsc //"_" // num // ".dat")
